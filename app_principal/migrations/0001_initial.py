# Generated by Django 4.2.2 on 2023-10-30 18:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('afiliado', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='turnos_seleccionados', to='app_principal.afiliado')),
            ],
        ),
        migrations.CreateModel(
            name='Profesional',
            fields=[
                ...
                ('turnos', models.ManyToManyField(related_name='profesionales', to='app_principal.turno')),
            ],
            options={
                'abstract': False,
            },
